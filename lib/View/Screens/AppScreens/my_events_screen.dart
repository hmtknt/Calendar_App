...
import 'package:flutter_events_2023/View/Screens/AppScreens/my_event_detail_screen.dart';
      ...
      body: SingleChildScrollView(
        child: Consumer<AddEventProvider>(
          builder: (context, AddEventProvider eventProvider, _) {
            if (eventProvider.myEventLoading) {
              // Loading indicator
              return const Center(
              ...
              if (eventProvider.myEventsStream == null) {
                eventProvider.fetchMyEvents(sp.uid.toString());
              }
              // Return ListView builder with data
              return StreamBuilder<List<DocumentSnapshot>>(
                stream: eventProvider.myEventsStream,
